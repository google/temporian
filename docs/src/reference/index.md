...
| [`EventSet.filter_max_moving_count()`][temporian.EventSet.filter_max_moving_count]                         | Skips events such that no more than one event is within a time window of `window_length`.                    |
