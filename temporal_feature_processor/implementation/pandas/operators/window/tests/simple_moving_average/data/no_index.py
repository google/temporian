...
# no index, just timestamp and a feature
INPUT = PandasEvent(
    [
        [pd.Timestamp("2013-01-01"), 10.0],
        [pd.Timestamp("2013-01-02"), 20.0],
        [pd.Timestamp("2013-01-03"), 30.0],
        [pd.Timestamp("2013-01-12"), 40.0],
    ],
...
OUTPUT = PandasEvent(
    [
        [pd.Timestamp("2013-01-01"), 10.0],
        [pd.Timestamp("2013-01-02"), 15.0],
        [pd.Timestamp("2013-01-03"), 20.0],
        [pd.Timestamp("2013-01-04"), 20.0],
        [pd.Timestamp("2013-01-05"), 20.0],
        [pd.Timestamp("2013-01-06"), 20.0],
        [pd.Timestamp("2013-01-07"), 20.0],
        [pd.Timestamp("2013-01-08"), 20.0],
        [pd.Timestamp("2013-01-09"), 25.0],
        [pd.Timestamp("2013-01-10"), 30.0],
        [pd.Timestamp("2013-01-11"), None],
        [pd.Timestamp("2013-01-12"), 40.0],
    ],
