...
class LessScalarNumpyImplementation(BaseArithmeticScalarNumpyImplementation):
    """Numpy implementation of the less scalar operator."""

    def __init__(self, operator: LessScalarOperator) -> None:
