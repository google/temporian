...
from temporian.core.operators.glue import (
    GlueOperator as CurrentOperator,
)
...
class GlueBeamImplementation(BeamOperatorImplementation):
    def call(self, **inputs: BeamEventSet) -> Dict[str, BeamEventSet]:
        ...
        output = sum(evsets, start=tuple())
        return {"output": output}


implementation_lib.register_operator_implementation(
    CurrentOperator, GlueBeamImplementation
)
