...
from temporian.core.operators.lag import (
    LagOperator as CurrentOperator,
)
...
class LagBeamImplementation(BeamOperatorImplementation):
...
implementation_lib.register_operator_implementation(
    CurrentOperator, LagBeamImplementation
)
