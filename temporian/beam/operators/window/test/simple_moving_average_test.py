...
class IOTest(absltest.TestCase):
    def test_base(self):
        ...
        input_data = event_set(
            timestamps=[1, 2, 3, 4, 5, 1, 2, 3],
            features={
                "a": ["x", "x", "x", "x", "x", "y", "y", "y"],
                "b": [1, 1, 1, 2, 2, 1, 1, 1],
                "c": [2.0, 3.0, 4.0, 3.0, 2.0, 22.0, 23.0, 24.0],
                "d": [100.0, 101.0, 102.0, 103.0, 104.0, 105.0, 106.0, 106.0],
        ...
        # Define computation
        output_node = simple_moving_average(input_data.node(), 3)
    ...
    def test_with_sampling(self):
        ...
        # Define computation
        output_node = simple_moving_average(
