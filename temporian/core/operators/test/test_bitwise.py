...
class BitwiseTest(absltest.TestCase):
    ...
    def setUp(self):
        self.evset_1 = event_set(
            timestamps=[1, 2, 3, 4], features={"x": [5, 9, 12, 3]}
        )
    ...
    def test_correct_and(self) -> None:
        ...
        assertOperatorResult(self, bitwise_and(self.evset_1, self.evset_2), expected)
    ...
    def test_correct_or(self) -> None:
        ...
        assertOperatorResult(self, bitwise_or(self.evset_1, self.evset_2), expected)
    ...
    def test_correct_xor(self) -> None:
        ...
        assertOperatorResult(self, bitwise_xor(self.evset_1, self.evset_2), expected)
