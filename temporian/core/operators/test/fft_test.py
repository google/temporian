...
class FFTOperatorTest(absltest.TestCase):
    def test_good(self):
        ...
        fft(input, 20)
        fft(input, 20, window="hamming")
        fft(input, 20, window="hamming", num_spectral_lines=10)

    def test_wrong_dtype(self):
        input = input_node([("a", DType.FLOAT64)])
    ...
    def test_wrong_num_spectral_lines(self):
        ...
        with self.assertRaisesRegex(
            ...
            fft(input, 20, num_spectral_lines=15)
